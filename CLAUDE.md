...
Tests live in `tests/` and use pytest + moto v5 + responses. 631 tests (599 unit + 32 integration), 97% coverage.
...
| `test_lambda_ecb_ingestion.py` | `ECBHandler` — SDMX parsing, API calls, integration (22 tests) |
